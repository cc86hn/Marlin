...
#define STRING_CONFIG_H_AUTHOR "(CC86, K8400)" // Who made the changes.
 ...
 */
// Note:
// - Configuration from Vendor uses 5,5,5 (https://github.com/Velleman/Vertex-Firmware-H2/blob/master/vertex-m1-v1.4-h2/Marlin/Configuration.h)
// - RepRap Forum Thread suggests to use 71,71,? (http://forums.reprap.org/read.php?245,780199)
...
#define X_MIN_POS 0
#define Y_MIN_POS 0     // TODO: changed, was 20
#define Z_MIN_POS 0
